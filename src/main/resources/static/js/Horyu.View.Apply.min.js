...
"CLOSE"===a.options.eventStatus?c.text("\ud604\uc7ac \uc751\ubaa8 \uc2e0\uccad\uc744 \ubc1b\uc9c0 \uc54a\uc2b5\ub2c8\ub2e4."):"LOTTERY"===a.options.eventStatus&&(c.html("\uc544\ub798\uc5d0\uc11c \ud604\uc7ac \uc774\ubca4\ud2b8 \ub2f9\ucca8\uc790 \ubaa9\ub85d\uc744 \ud655\uc778\ud558\uc2e4 \uc218 \uc788\uc2b5\ub2c8\ub2e4."),c.removeClass("alert-warning"),c.addClass("alert-success"),a.companyGiftTable=new Horyu.View.CompanyGiftTable,a.companyGiftTable.init(),a.companyGiftTable.updateTable(a.options.companyGiftData,
a.options.eventWinnerData))};a.bindEvents=function(){$(".submitBtn").click(function(){$("#applyForm").parsley().validate()&&grecaptcha.execute()});$(".notSubscriberBtn").click(function(){$("#submit-modal").modal()})};return{init:function(){a.init()}}};function onReCaptchaCallback(){$("#applyForm").submit()};
