...
0,a.options.applyCount,0,5,b);b.error?console.error(b.error):b.start();b=a.options.companyGiftData.sum("prizeAmount");b=(a.options.applyCount/b).toFixed(2);$("#competitionRate").text(b+" : 1");c.html('\x3ca style\x3d"font-weight: bold; font-size: 20pt;"\x3e\ub2e4\uc74c \uc2dc\uac04 \uc804\uc5d0 \uc774\ubbf8 \uc751\ubaa8 \uc2e0\uccad\uc774 \ub9c8\uac10\ub418\uc5c8\uc2b5\ub2c8\ub2e4.\x3c/a\x3e\x3cbr/\x3e\x3ca id\x3d"time-countdown" style\x3d"font-weight: bold; font-size: 32pt;"\x3e\x3c/a\x3e');c=moment.unix(a.options.eventEndTime).subtract(new Date);
$("#time-countdown").countdown(c.toDate(),{elapse:!0}).on("update.countdown",function(a){$(this).html(a.strftime("%D\uc77c %H\uc2dc\uac04 %M\ubd84 %S\ucd08"))})}else"OPEN"===a.options.eventStatus?(c.html('\x3ca style\x3d"font-size: 12pt;"\x3e\x3ca id\x3d"time-countdown" style\x3d"font-weight: bold;"\x3e\x3c/a\x3e \uc774\ud6c4 \uc751\ubaa8 \uc2e0\uccad\uc774 \ub9c8\uac10\ub429\ub2c8\ub2e4.\x3c/a\x3e'),b={useEasing:!0,useGrouping:!0,separator:",",decimal:".",suffix:"\uba85"},b=new CountUp("applyCount",
0,a.options.applyCount,0,3,b),b.error?console.error(b.error):b.start(),b=a.options.companyGiftData.sum("prizeAmount"),b=(a.options.applyCount/b).toFixed(2),$("#competitionRate").text(b+" : 1"),$("#time-countdown").countdown(moment.unix(a.options.eventEndTime).toDate()).on("update.countdown",function(a){$(this).html(a.strftime("%D\uc77c %H\uc2dc\uac04 %M\ubd84 %S\ucd08"))}).on("finish.countdown",function(a){$(".alert-banner").html('\x3ca style\x3d"font-weight: bold; font-size: 20pt;"\x3e\uc751\ubaa8 \uc2e0\uccad\uc774 \ub9c8\uac10\ub418\uc5c8\uc2b5\ub2c8\ub2e4.\x3c/a\x3e');
window.location.reload()}),a.companyGiftTable=new Horyu.View.CompanyGiftTable({includeEventWinner:!1}),a.companyGiftTable.init(),a.companyGiftTable.updateTable(a.options.companyGiftData,a.options.eventWinnerData)):"CLOSE"===a.options.eventStatus?c.text("\ud604\uc7ac \uc751\ubaa8 \uc2e0\uccad\uc744 \ubc1b\uc9c0 \uc54a\uc2b5\ub2c8\ub2e4."):"LOTTERY"===a.options.eventStatus&&(c.html("\uc544\ub798\uc5d0\uc11c \ud604\uc7ac \uc774\ubca4\ud2b8 \ub2f9\ucca8\uc790 \ubaa9\ub85d\uc744 \ud655\uc778\ud558\uc2e4 \uc218 \uc788\uc2b5\ub2c8\ub2e4."),
c.removeClass("alert-warning"),c.addClass("alert-success"),a.companyGiftTable=new Horyu.View.CompanyGiftTable,a.companyGiftTable.init(),a.companyGiftTable.updateTable(a.options.companyGiftData,a.options.eventWinnerData))};a.bindEvents=function(){$(".submitBtn").click(function(){$("#applyForm").parsley().validate()&&grecaptcha.execute()});$(".notSubscriberBtn").click(function(){$("#submit-modal").modal()})};return{init:function(){a.init()}}};
function onReCaptchaCallback(){$("#applyForm").submit()};
//# sourceMappingURL=Horyu.View.Apply.min.js.map