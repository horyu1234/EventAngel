...
c.companyId+'"/\x3e'),g=$('\x3ca style\x3d"font-size: 16pt;font-weight: bold;"\x3e'+c.companyName+"\x3c/a\x3e"),h=$('\x3ca style\x3d"color: gray"\x3e'+c.companyDetail+"\x3c/a\x3e");null!==c.companyLogoImageFileName&&(d.append(f),d.append("\x3cbr/\x3e"));d.append(g);d.append("\x3cbr/\x3e");d.append(h);return d};a.popEventWinner=function(b){var c=a.currentEventWinnerData.filter(function(a){return a.prizeId===b}),c=c.sortBy(function(a){return moment(a.winTime).unix()});if(0===c.length)return null;var d=
c[0];a.currentEventWinnerData.remove(function(a){return a.applicant.applyEmail===d.applicant.applyEmail});return d};a.getTotalGiftSize=function(b){var c=0;a.companyGiftData.filter(function(a){return a.companyId===Number(b)}).forEach(function(a){c++});return c};a.getTotalGiftAmount=function(b){var c=0;a.companyGiftData.filter(function(a){return a.companyId===Number(b)}).forEach(function(a){c+=a.prizeAmount});return c};a.deepCopy=function(a){return JSON.parse(JSON.stringify(a))};return{init:a.init,
updateTable:function(b,c){a.companyGiftData=a.deepCopy(b);a.currentEventWinnerData=a.deepCopy(c);a.updateTable()},getNextLotteryGift:function(){return a.nextLotteryGift}}};
