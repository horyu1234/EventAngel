...
b.append($('\x3ctd class\x3d"apply-youtubeNickname"\x3e').text(a.youtubeNickname));b.append($('\x3ctd class\x3d"apply-ipAddress"\x3e').text(a.ipAddress));b.append($('\x3ctd class\x3d"apply-referer"\x3e').text(a.referer));b.append($('\x3ctd class\x3d"apply-userAgent"\x3e').text(a.userAgent));b.append($('\x3ctd class\x3d"apply-fingerprint2"\x3e').text(a.fingerprint2));b.append($('\x3ctd class\x3d"apply-duplicated"\x3e').text(a.duplicated));a.duplicated?(b.addClass("table-warning"),b.append($("\x3ctd\x3e").html($('\x3cbutton type\x3d"button" class\x3d"btn btn-danger btn-sm notDuplicatedBtn"\x3e\uc911\ubcf5 \uc751\ubaa8 \ucc98\ub9ac \ucde8\uc18c\x3c/button\x3e').attr("data-apply-email",
