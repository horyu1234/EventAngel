...
timeout:12E4}).done(function(b){if("object"!==typeof b)$(".lotteryBtn").html('\x3ci class\x3d"fas fa-exclamation-triangle"\x3e\x3c/i\x3e\x26nbsp; \ucd94\ucca8\uc5d0 \uc2e4\ud328\ud558\uc600\uc2b5\ub2c8\ub2e4.'),$(".lotteryBtn").removeClass("btn-success"),$(".lotteryBtn").addClass("btn-danger"),setTimeout(function(){location.reload()},4E3);else{var d=moment();5E3<=moment.duration(d.diff(c)).valueOf()?a.lotteryOut(b):setTimeout(function(){a.lotteryOut(b)},Math.round(3E3*Math.random())+3E3)}}).fail(function(a){$(".lotteryBtn").html('\x3ci class\x3d"fas fa-exclamation-triangle"\x3e\x3c/i\x3e\x26nbsp; \ucd94\ucca8\uc5d0 \uc2e4\ud328\ud558\uc600\uc2b5\ub2c8\ub2e4.');
$(".lotteryBtn").removeClass("btn-success");$(".lotteryBtn").addClass("btn-danger");setTimeout(function(){location.reload()},4E3)})}})};a.lotteryOut=function(c){$(".lotteryBtn").html("\uc5f4\ub9b0 \ucc3d\uc744 \ud655\uc778\ud574\uc8fc\uc138\uc694.");var b=a.companyGiftTable.getNextLotteryGift(),d=$("#modal-company-logo");null!==b.companyLogoImageFileName?(d.show(),d.attr("src","/companyLogo?companyId\x3d"+b.companyId)):d.hide();$("#modal-companyName").text(b.companyName);$("#modal-companyDetail").text(b.companyDetail);
$("#modal-prizeName").text(b.prizeName);$("#modal-youtubeNickname").text(c.youtubeNickname);$("#modal-email").text(c.applyEmail);$("#lottery-modal").modal({backdrop:"static",keyboard:!1})};a.isIE=function(){var a=window.navigator.userAgent.toLowerCase();return"netscape"===navigator.appName.toLowerCase()&&-1!==a.search("trident")||-1!==a.indexOf("msie")?!0:!1};return{init:function(){a.init()}}};
