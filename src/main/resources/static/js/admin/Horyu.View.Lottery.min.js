...
(c.text(e.prizeName),d.html('\x3ci class\x3d"fas fa-random"\x3e\x3c/i\x3e\x26nbsp; \ub2e4\uc74c \uc0c1\ud488 \ucd94\ucca8\ud558\uae30'))};a.bindEvents=function(){$(".lotteryBtn").click(function(){if(a.isIE())$("#ie-modal").modal({backdrop:"static",keyboard:!1});else{$(".lotteryBtn").attr("disabled","");$(".lotteryBtn").html('\x3ci class\x3d"fas fa-spinner fa-pulse"\x3e\x3c/i\x3e\x26nbsp; \ucd94\ucca8 \uc911\uc785\ub2c8\ub2e4...');var b=moment();$.ajax({type:"POST",url:"./lottery",data:{prizeId:a.companyGiftTable.getNextLotteryGift().prizeId},
timeout:12E4}).done(function(c){var d=moment();5E3<=moment.duration(d.diff(b)).valueOf()?a.lotteryOut(c):setTimeout(function(){a.lotteryOut(c)},Math.round(3E3*Math.random())+3E3)}).fail(function(a){$(".lotteryBtn").html('\x3ci class\x3d"fas fa-exclamation-triangle"\x3e\x3c/i\x3e\x26nbsp; \ucd94\ucca8\uc5d0 \uc2e4\ud328\ud558\uc600\uc2b5\ub2c8\ub2e4.');$(".lotteryBtn").removeClass("btn-success");$(".lotteryBtn").addClass("btn-danger");setTimeout(function(){location.reload()},4E3)})}})};a.lotteryOut=
function(b){$(".lotteryBtn").html("\uc5f4\ub9b0 \ucc3d\uc744 \ud655\uc778\ud574\uc8fc\uc138\uc694.");var c=a.companyGiftTable.getNextLotteryGift();$("#modal-companyName").text(c.companyName);$("#modal-companyDetail").text(c.companyDetail);$("#modal-prizeName").text(c.prizeName);$("#modal-youtubeNickname").text(b.youtubeNickname);$("#modal-email").text(b.applyEmail);$("#lottery-modal").modal({backdrop:"static",keyboard:!1})};a.isIE=function(){var a=window.navigator.userAgent.toLowerCase();return"netscape"===
navigator.appName.toLowerCase()&&-1!==a.search("trident")||-1!==a.indexOf("msie")?!0:!1};return{init:function(){a.init()}}};
